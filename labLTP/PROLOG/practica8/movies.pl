...
% movie(X,Y,Z) indica que la película de título X 
%    fue dirigida por Y en el año Z
...
movie("El sueño eterno", "Howard Hawks", 1946).
movie("Cayo Largo", "John Huston", 1948).

% cast(X,Y) indica que la película de título X tiene como 
%           reparto a los actores/actrices de la lista Y
