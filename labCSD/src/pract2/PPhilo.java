    ...
    void simulate(String s) {
        ...
        switch (type) {
            case 0: 
                ...
                break;
            case 1: 
                System.out.println("Assimetry (last/but last).- APARCAO");
                t = new RegularTable(sman);
                for (i=0; i<5; i++){
                    if (i != 4) {
                ...
                break;
            case 2: 
                System.out.println("Assimetry (even/odd).- APARCAO");
                t = new RegularTable(sman);
                for (i=0; i<5; i++) {
                    if (i % 2 == 0) {
                        philo[i]=new Philo(i,cycles,delay,t); 
                ...
                break;
            case 3: 
                System.out.println("Both or None.- APARCAO");
                t = new BothOrNoneTable(sman);
                for (i=0; i<5; i++) philo[i]=new BothOrNonePhilo(i,cycles,delay,t);
                break;
            case 4: 
                System.out.println("Limited capacity Dining Room.- APARCAO");
