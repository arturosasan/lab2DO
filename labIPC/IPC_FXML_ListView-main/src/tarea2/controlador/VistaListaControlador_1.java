...
//        controlador2.setPersona(personasListView.
//                               getSelectionModel().getSelectedItem());
//        stage.show();
        stage.showAndWait();
        if (controlador2.isAceptarPress()) {
            Persona personaModificad=controlador2.getPersona();
            datos.add(personaModificad);
...
//        stage.show();
        ...
        if (controlador2.isAceptarPress()) {
            Persona personaModificad=controlador2.getPersona();
            datos.set(personasListView.getSelectionModel().getSelectedIndex(),
                         personaModificad);
